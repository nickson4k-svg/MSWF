...
export const ShaderBackground = ({
  ...
  if (shaderType.startsWith('grain')) {
    ...
    return (
      <div className="fixed inset-0 w-full h-full -z-10 overflow-hidden pointer-events-none bg-zinc-950">
        {/* Hardware accelerated resolution downsampling: renders GrainGradient at 50% resolution scaled up 2x */}
        <div className="absolute top-0 left-0 w-[50vw] h-[50vh] origin-top-left scale-200">
          <GrainGradient
            width="50vw"
            height="50vh"
